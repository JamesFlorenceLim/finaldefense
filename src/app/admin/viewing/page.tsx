        ...
        {assignments.map((assignment) => (
          <li key={assignment.id} className="flex justify-between items-center">
            ...
            <button
              ...
              onClick={() => handleRemoveAssignment(assignment.id, assignment.van_driver_operator_id, assignment.schedule_id)}
            >
              Remove
            </button>
          </li>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg max-w-4xl max-h-[90vh] w-full overflow-y-auto ml-44">
              ...
              <div className="mb-4">
                ...
                {vanDriverOperators
                  ...
                  const existingAssignments = selectedScheduleData.assignments || [];
                  return !existingAssignments.some(assignment => assignment.VanDriverOperator.id === vdo.id);
                  })
                  .map((vdo) => (
