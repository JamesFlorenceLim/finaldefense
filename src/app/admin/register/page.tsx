...
const RegisterPage = () => {
  ...
  const [roleType, setRoleType] = useState(''); // Updated field for roleType
  ...
  const handleEditSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await axios.put(`/api/register/${selectedUser.id}`, { username, password, roleType });
        ...
        <div className="bg-white p-6 rounded shadow-lg w-full max-w-md mx-auto">
          ...
          <form onSubmit={handleRegisterSubmit}>
            ...
            <div className="mb-4">
              ...
              <select value={roleType} onChange={(e) => setRoleType(e.target.value)} required className="w-full px-3 py-2 border rounded">
